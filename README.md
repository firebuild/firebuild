...
Install the build dependencies:
    ...
    sudo apt update
    sudo apt install cmake bats eatmydata fakeroot graphviz libconfig++-dev node-d3 libevent-dev libxxhash-dev libjemalloc-dev libfmt-dev moreutils python3-jinja2 fakeroot
