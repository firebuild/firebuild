...
#endif
#ifdef F_FLUSH_DATA
  DEBUG_VALUE_VALUE(f, cmd, F_FLUSH_DATA)
#endif
#ifdef F_CHKCLEAN
  DEBUG_VALUE_VALUE(f, cmd, F_CHKCLEAN)
#endif
#ifdef F_PREALLOCATE
  DEBUG_VALUE_VALUE(f, cmd, F_PREALLOCATE)
#endif
#ifdef F_SETSIZE
  DEBUG_VALUE_VALUE(f, cmd, F_SETSIZE)
#endif
#ifdef F_RDADVISE
  DEBUG_VALUE_VALUE(f, cmd, F_RDADVISE)
#endif
#ifdef F_RDAHEAD
  DEBUG_VALUE_VALUE(f, cmd, F_RDAHEAD)
#endif
#ifdef F_NOCACHE
  DEBUG_VALUE_VALUE(f, cmd, F_NOCACHE)
#endif
#ifdef F_LOG2PHYS
  DEBUG_VALUE_VALUE(f, cmd, F_LOG2PHYS)
#endif
#ifdef F_GETPATH
  DEBUG_VALUE_VALUE(f, cmd, F_GETPATH)
#endif
#ifdef F_FULLFSYNC
  DEBUG_VALUE_VALUE(f, cmd, F_FULLFSYNC)
#endif
#ifdef F_PATHPKG_CHECK
  DEBUG_VALUE_VALUE(f, cmd, F_PATHPKG_CHECK)
#endif
#ifdef F_FREEZE_FS
  DEBUG_VALUE_VALUE(f, cmd, F_FREEZE_FS)
#endif
#ifdef F_THAW_FS
  DEBUG_VALUE_VALUE(f, cmd, F_THAW_FS)
#endif
#ifdef F_ADDSIGS
  DEBUG_VALUE_VALUE(f, cmd, F_ADDSIGS)
#endif
#ifdef F_ADDFILESIGS
  DEBUG_VALUE_VALUE(f, cmd, F_ADDFILESIGS)
#endif
#ifdef F_NODIRECT
  DEBUG_VALUE_VALUE(f, cmd, F_NODIRECT)
#endif
#ifdef F_GETPROTECTIONCLASS
  DEBUG_VALUE_VALUE(f, cmd, F_GETPROTECTIONCLASS)
#endif
#ifdef F_SETPROTECTIONCLASS
  DEBUG_VALUE_VALUE(f, cmd, F_SETPROTECTIONCLASS)
#endif
#ifdef F_LOG2PHYS_EXT
  DEBUG_VALUE_VALUE(f, cmd, F_LOG2PHYS_EXT)
#endif
#ifdef F_GETLKPID
  DEBUG_VALUE_VALUE(f, cmd, F_GETLKPID)
#endif
#ifdef F_SETBACKINGSTORE
  DEBUG_VALUE_VALUE(f, cmd, F_SETBACKINGSTORE)
#endif
#ifdef F_GETPATH_MTMINFO
  DEBUG_VALUE_VALUE(f, cmd, F_GETPATH_MTMINFO)
#endif
#ifdef F_GETCODEDIR
  DEBUG_VALUE_VALUE(f, cmd, F_GETCODEDIR)
#endif
#ifdef F_SETNOSIGPIPE
  DEBUG_VALUE_VALUE(f, cmd, F_SETNOSIGPIPE)
#endif
#ifdef F_GETNOSIGPIPE
  DEBUG_VALUE_VALUE(f, cmd, F_GETNOSIGPIPE)
#endif
#ifdef F_TRANSCODEKEY
  DEBUG_VALUE_VALUE(f, cmd, F_TRANSCODEKEY)
#endif
#ifdef F_SINGLE_WRITER
  DEBUG_VALUE_VALUE(f, cmd, F_SINGLE_WRITER)
#endif
#ifdef F_GETPROTECTIONLEVEL
  DEBUG_VALUE_VALUE(f, cmd, F_GETPROTECTIONLEVEL)
#endif
#ifdef F_FINDSIGS
  DEBUG_VALUE_VALUE(f, cmd, F_FINDSIGS)
#endif
#ifdef F_ADDFILESIGS_FOR_DYLD_SIM
  DEBUG_VALUE_VALUE(f, cmd, F_ADDFILESIGS_FOR_DYLD_SIM)
#endif
#ifdef F_BARRIERFSYNC
  DEBUG_VALUE_VALUE(f, cmd, F_BARRIERFSYNC)
#endif
#ifdef F_OFD_SETLK
  DEBUG_VALUE_VALUE(f, cmd, F_OFD_SETLK)
#endif
#ifdef F_OFD_SETLKW
  DEBUG_VALUE_VALUE(f, cmd, F_OFD_SETLKW)
#endif
#ifdef F_OFD_GETLK
  DEBUG_VALUE_VALUE(f, cmd, F_OFD_GETLK)
#endif
#ifdef F_OFD_SETLKWTIMEOUT
  DEBUG_VALUE_VALUE(f, cmd, F_OFD_SETLKWTIMEOUT)
#endif
#ifdef F_ADDFILESIGS_RETURN
  DEBUG_VALUE_VALUE(f, cmd, F_ADDFILESIGS_RETURN)
#endif
#ifdef F_CHECK_LV
  DEBUG_VALUE_VALUE(f, cmd, F_CHECK_LV)
#endif
#ifdef F_PUNCHHOLE
  DEBUG_VALUE_VALUE(f, cmd, F_PUNCHHOLE)
#endif
#ifdef F_TRIM_ACTIVE_FILE
  DEBUG_VALUE_VALUE(f, cmd, F_TRIM_ACTIVE_FILE)
#endif
#ifdef F_SPECULATIVE_READ
  DEBUG_VALUE_VALUE(f, cmd, F_SPECULATIVE_READ)
#endif
#ifdef F_GETPATH_NOFIRMLINK
  DEBUG_VALUE_VALUE(f, cmd, F_GETPATH_NOFIRMLINK)
#endif
#ifdef F_ADDFILESIGS_INFO
  DEBUG_VALUE_VALUE(f, cmd, F_ADDFILESIGS_INFO)
#endif
#ifdef F_ADDFILESUPPL
  DEBUG_VALUE_VALUE(f, cmd, F_ADDFILESUPPL)
#endif
#ifdef F_GETSIGSINFO
  DEBUG_VALUE_VALUE(f, cmd, F_GETSIGSINFO)
#endif
#ifdef F_TRANSFEREXTENTS
  DEBUG_VALUE_VALUE(f, cmd, F_TRANSFEREXTENTS)
#endif
#ifdef F_ATTRIBUTION_TAG
  DEBUG_VALUE_VALUE(f, cmd, F_ATTRIBUTION_TAG)
#endif
